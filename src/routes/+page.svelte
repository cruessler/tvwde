...
<h1 class="mx-6 mb-2 flex flex-row gap-x-2 text-2xl font-bold text-neutral-700">
...
<h2 class="mx-6 mb-4 border-b-1 border-neutral-700 text-2xl">Produktionen im Fokus</h2>

{#each data.productions as production}
  <div class="relative mx-6 mb-4 h-50 bg-slate-200">
  ...
  <div class="mx-6 mb-6 line-clamp-6 whitespace-pre-line">{production.description_de}</div>
